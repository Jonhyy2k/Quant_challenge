...
USAGE:
======
python pairs_backtest.py --pair1 "AG US Equity" --pair2 "PAAS US Equity" --start-date 2025-01-01 --end-date 2025-01-31
python pairs_backtest.py --pair1 "HOC LN Equity" --pair2 "RIO LN Equity" --start-date 2025-01-01 --end-date 2025-01-31
python pairs_backtest.py --pair1 "CSAN3 BZ Equity" --pair2 "EID IN Equity" --start-date 2025-01-01 --end-date 2025-01-31

IMPORTANT:
==========
You MUST provide the FULL Bloomberg ticker format including exchange and asset type.
Examples:
  - US stocks: "AAPL US Equity", "VALE US Equity"
  - London: "HOC LN Equity", "RIO LN Equity"
  - Brazil: "CSAN3 BZ Equity", "PETR4 BZ Equity"
  - India: "EID IN Equity"
...
def run_backtest(ticker1, ticker2, start_date, end_date,
    ...
    try:
        # Use tickers exactly as provided (no auto-completion)
...
Examples:
  # US stocks
  python pairs_backtest.py --pair1 "AG US Equity" --pair2 "PAAS US Equity" \\
    --start-date 2025-01-01 --end-date 2025-01-31

  # London stocks
  python pairs_backtest.py --pair1 "HOC LN Equity" --pair2 "RIO LN Equity" \\
    --start-date 2025-01-01 --end-date 2025-01-31

  # Brazil stocks
  python pairs_backtest.py --pair1 "CSAN3 BZ Equity" --pair2 "PETR4 BZ Equity" \\
    --start-date 2025-01-01 --end-date 2025-01-31

  # Custom transaction costs and position size
  python pairs_backtest.py --pair1 "MP US Equity" --pair2 "REMX US Equity" \\
    --start-date 2025-01-01 --end-date 2025-01-31 \\
    --transaction-cost 0.002 --position-size 50000

  # Different data frequency
  python pairs_backtest.py --pair1 "BABA US Equity" --pair2 "KWEB US Equity" \\
    --start-date 2025-01-01 --end-date 2025-01-31 --interval 5

IMPORTANT: Use FULL Bloomberg ticker format (e.g., "AAPL US Equity", "HOC LN Equity")
        """
    )

    parser.add_argument('--pair1', type=str, required=True,
                       help='First asset ticker (FULL Bloomberg format: "TICKER EXCHANGE Equity")')
    parser.add_argument('--pair2', type=str, required=True,
                       help='Second asset ticker (FULL Bloomberg format: "TICKER EXCHANGE Equity")')
